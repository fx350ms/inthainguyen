...
public abstract class InTNWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static InTNWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(InTNWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<InTNDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<InTNDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<InTNDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<InTNDbContext, Task<T>> func)
    {
        T result;
