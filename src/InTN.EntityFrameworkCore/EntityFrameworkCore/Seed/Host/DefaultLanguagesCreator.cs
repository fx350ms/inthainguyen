...
namespace InTN.EntityFrameworkCore.Seed.Host;

public class DefaultLanguagesCreator
{
    public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

    private readonly InTNDbContext _context;

    private static List<ApplicationLanguage> GetInitialLanguages()
    {
        var tenantId = InTNConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(InTNDbContext context)
    {
        _context = context;
    }
