...
namespace InTN.Migrations
{
    ...
    [Migration("20250714101124_process-step-remove-process-foreign-key")]
    partial class processstepremoveprocessforeignkey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InTN.Entities.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InTN.Entities.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InTN.Entities.CustomerBalanceHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CustomerBalanceHistories");
                });

            modelBuilder.Entity("InTN.Entities.FileUpload", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InTN.Entities.IdentityCode", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("InTN.Entities.Order", b =>
                {
                    ...
                    b.Property<bool>("IsReceiveByOthers")
                        .HasColumnType("bit");

                    b.Property<bool>("IsRequireDesign")
                        .HasColumnType("bit");

                    b.Property<bool>("IsRequireTestSample")
                        .HasColumnType("bit");

                    b.Property<bool>("IsStoreSample")
                        .HasColumnType("bit");
                    ...
                    b.Property<decimal?>("TotalCustomerPay")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("InTN.Entities.OrderAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InTN.Entities.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InTN.Entities.OrderLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InTN.Entities.ProcessStepGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InTN.Entities.ProductCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InTN.Entities.ProductNote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InTN.Entities.ProductPriceCombination", b =>
                {
                    ...
                    b.Property<string>("PriceCombination")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("InTN.Entities.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InTN.Entities.Supplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InTN.Entities.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("InTN.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("InTN.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("InTN.Entities.OrderDetail", b =>
                {
                    b.HasOne("InTN.Entities.Order", null)
            ...
            modelBuilder.Entity("InTN.Entities.Product", b =>
                {
                    ...
                    b.HasOne("InTN.Entities.ProductCategory", "ProductCategory")
                        .WithMany()
                        .HasForeignKey("ProductCategoryId");

                    b.HasOne("InTN.Entities.ProductType", "ProductType")
                        .WithMany()
                        .HasForeignKey("ProductTypeId");

                    b.HasOne("InTN.Entities.Supplier", "Supplier")
                        .WithMany()
